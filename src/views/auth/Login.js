          ...
          <div className="w-full lg:w-4/12 px-4">
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
              <div className="rounded-t mb-0 px-6 py-6">
                ...
                <div className="btn-wrapper text-center">
                  <button
                    ...
                    type="button"
                    onClick={(e) => {
                      alert('Fazer essa rotina!')
                    }}
                  >
                    <img
                      alt="..."
                      className="w-5 mr-1"
                      src={require("assets/img/facebook-svg.svg")}
                    />
                    Facebook
                  </button>
                  {/*
              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                <div className="text-gray-500 text-center mb-3 font-bold">
                  <small>{/*Or sign in with credentials*/} Ou entre com seu</small>
                </div>
                <form>
            ...
            <div className="flex flex-wrap mt-6 relative">
              <div className="w-1/2">
                ...
                >
                  <small>{/*Forgot password?*/} Esqueceu a senha?</small>
                </a>
              </div>
              <div className="w-1/2 text-right">
                <Link to="/auth/register" className="text-gray-300">
                  <small>{/*Create new account*/} Criar nova conta</small>
                </Link>
              </div>
            </div>
          </div>
